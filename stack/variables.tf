...
variable "zabbix_name" {
  description = "Zabbix Database User Name."
  default     = "zabbix"
}

variable "zabbix_password" {
  description = "Zabbix Database User Password."
  default     = "MyZabbixPassw0rd!"
}

variable "zabbix_schema" {
  description = "Zabbix MySQL Schema"
  default     = "zabbix"
}
...
variable "zabbix_instance_name" {
  description = "Name of the Zabbix compute instance"
